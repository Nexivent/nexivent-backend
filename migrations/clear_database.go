...
func seedEventos(
	...
	eventos := []eventoSeed{
		...
		},
		{
			...
			Descripcion:       "¡Ayúdanos a apoyar una causa especial mientras disfrutas de un ambiente lleno de sabor, música y alegría! Te invitamos a vivir una tarde inolvidable con nuestra deliciosa pollada al estilo tradicional y un gran baile con los mejores ritmos del momento.",
			...
			HoraInicio:        20,
			MinutoInicio:      30,
			ImagenDescripcion: "https://nuestragente2010.com/wp-content/uploads/2012/05/chorri-y-el-pollo-tour.jpg",
			ImagenPortada:     "https://nuestragente2010.com/wp-content/uploads/2012/05/chorri-y-el-pollo-tour.jpg",
			VideoPresentacion: "https://nexivent-multimedia.s3.us-east-2.amazonaws.com/YTDown.com_YouTube_SPOT-GRAN-POLLADA-PROSALUD-EN-SANPEDRO-D_Media_8Ode8ZzJVKU_001_1080p+(1).mp4",
			ImagenEscenario:   "https://elpopular.cronosmedia.glr.pe/original/2021/04/26/6086d6f27ffe4471156953e2.jpg",
			Sectores: []sectorSeed{
				{Nombre: "VIP", Capacidad: 500, PrecioBase: 280},
				{Nombre: "Regular", Capacidad: 1200, PrecioBase: 180},
			},
			Perfiles: []string{"Adulto"},
			Tickets: []ticketSeed{
				{Nombre: "Preventa", InicioDiasAntes: 45, FinDiasAntes: 10, MultiplicadorPrecio: 0.92},
				{Nombre: "General", InicioDiasAntes: 25, FinDiasAntes: 0, MultiplicadorPrecio: 1.0},
			},
			Cupon: &couponSeed{Codigo: "DIABETES", Valor: 5, Tipo: 1},
		},
		{
