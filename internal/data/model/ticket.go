...
type Ticket struct {
	ID              uint64              `gorm:"column:ticket_id;primaryKey" json:"id"`
	...
	CodigoQR        string              `gorm:"column:codigo_qr" json:"codigoQr"`
	EstadoDeTicket  util.EstadoDeTicket `gorm:"column:estado_de_ticket" json:"estadoDeTicket"`
}
